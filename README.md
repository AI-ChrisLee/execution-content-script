...
It asks which layer you record on, then 2 more things. `00_PREP.md` lands in your episode folder,
your whole video as an outline. Read it, fix a word, and say "The prep is approved." Then
`03_SCRIPT.md` lands in the same folder, with 6 alternate first lines at the bottom.
